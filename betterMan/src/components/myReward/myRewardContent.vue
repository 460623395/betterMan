<template>
    <div class="publicAllContentBg" id="myRewardContent">
        <!--头部导航-->
        <van-nav-bar title="订单详情" class="globalNavBarHeaderClass"
                     left-text="返回"
                     left-arrow
        ...
        <!--其余剩下的信息-->
        <van-cell-group v-if="orderLoadingDone&&orderContentData.taskStatus!=1">
                    ...
                    success:(res)=>{
                        ...
                        if(res.data.code===200){
                            this.orderContentData={
                                ...
                                //接单人名称
                                orderTakeMan:res.data.result.orderdetails.bname,
                                //订单号
                                orderNum:res.data.result.orderdetails.ordernum,
                                //接单时间
                                cTime:res.data.result.orderdetails.ctime
                            };
                            console.log(this.orderContentData);
                            //显示的步骤状态
