<template>
    <div class="publicAllContentBg none fullHeight whiteBg" id="shopCenterSearchResult">
        <!--头部导航-->
        ...
        <div class="searchResultBox">
            ...
            >
                <ul class="list">
                    <li v-for="item in goodList.list" @click="goToGoodContentFn(item.id)" :key="item.id">
                        <div class="goodsListStyle">
                            ...
                            <div class="goodInfo">
                                <div>
                                    <p class="title">哦牛批信息哦牛批信息哦牛批信息哦牛批信息哦牛批信息哦牛批信息哦牛批信息哦牛批信息</p>
                                    <div class="activity">
