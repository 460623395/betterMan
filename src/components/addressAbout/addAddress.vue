<template>
    <div class="publicAllContentBg" id="addressEdit">
        <!--头部导航-->
        <van-nav-bar title="添加新地址" class="globalNavBarHeaderClass" left-text="返回"
                     left-arrow
        ...
        <!--确认编辑按钮-->
        <div class="editConfirmButton" @click="addConfirmFn">确认添加</div>
        <!--选择省市区的弹窗-->
        ...
        methods: {
            ...
            addConfirmFn(){
                ...
                if(this.addressData.name===""||this.addressData.name===null){
                    ...
                    this.tools.globalFn.publicToastFn(this,"请填写正确的联系电话");
                    return false;
                }
                ...
                //判断一下该用户的地址列表长度是否为0，如果是0把当前新增的设置为默认
                if(localStorage.userAddressListLength==="0"){
                    this.finalNeedAddress.isDefaultActive=1;
                }
                //走接口提交
